...
const FloatingForm = ({ isOpen: controlledIsOpen, onClose }) => {
  ...
  return (
    <div className={`floating-form-overlay ${isClosing ? 'closing' : ''}`}>
      <div className={`floating-form-card ${isClosing ? 'closing' : ''}`}>
        
        {/* Overlapping Circular Yellow Car Badge */}
        <div className="floating-form-car-badge">
          <svg className="badge-car-svg" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className="floating-form-header">
          <div className="floating-form-title-wrapper">
            ...
            <h2 className="floating-form-title">ENQUIRE NOW</h2>
            <span className="floating-form-gold-line"></span>
          </div>
          <p className="floating-form-subtitle">
            Fill the form and we will<br />contact you soon.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="floating-form-body">
          ...
          <div className="floating-form-field">
            ...
            >
              ...
              <option value="defensive">Defensive Driving Course</option>
              <option value="license_test">License Test Preparation</option>
            </select>
          </div>
          ...
          {/* Submit Button */}
          <button type="submit" className="floating-form-submit-btn">
            <span>SUBMIT NOW</span>
            <svg className="submit-arrow" viewBox="0 0 24 24" width="16" height="16" stroke="currentColor" strokeWidth="3" fill="none">
          ...
          <div className="floating-form-privacy">
            <svg className="privacy-shield-icon" viewBox="0 0 24 24" fill="currentColor" width="16" height="16">
